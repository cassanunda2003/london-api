...
class LondonServiceTest {
    ...
    private static final String allUsersJson = "[{\"id\":135,\"first_name\":\"John\",\"last_name\":\"Boam\",\"email\":\"john3boam@thetimes.co.uk\",\"ip_address\":\"113.71.242.185\",\"latitude\":51.50722,\"longitude\":-0.1275},{\"id\":135,\"first_name\":\"Micky\",\"last_name\":\"Adams\",\"email\":\"mickyadams@thetimes.co.uk\",\"ip_address\":\"113.71.242.185\",\"latitude\":80.50722,\"longitude\":-0.1275}]";
...
//  }
    ...
    @Test
    void getUsers() {
        LondonService londonService = new LondonService(londonRegisteredUsersMock);
    ...
    void getUsersInLondon() {
        LondonService allusers = new LondonService(allUsersMock);
        allusers.getUsersInLondon().subscribe(
                users -> {
                    assertEquals(1, (long) users.size(), "The number of users should be 1");
                    assertEquals("john3boam@thetimes.co.uk", users.get(0).getEmail(), "Email should be as expected");
